...
namespace test8
{
    class Program
    {
        ...
        {
            IWebDriver driver;
            // № 4: Проверка выбора в качестве пассажира подростка(от 12 лет) без взрослого
            ...
            element5.Click();
            Thread.Sleep(2000);
            IWebElement element1 = driver.FindElement(By.XPath("//div[contains(@id, 'youth')]//div[@class='col-numberbox-button']//button[@aria-label='Increment']"));
            element1.Click();
