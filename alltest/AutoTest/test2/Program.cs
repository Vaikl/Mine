...
namespace test2
{
    class Program
    {
        ...
        {
            IWebDriver driver;
            // № 10: Невозможность ввода пассажира ребенка(от 2 до 11 лет) без сопровождения взрослых
            ...
            element5.Click();
            Thread.Sleep(2000);
            IWebElement element1 = driver.FindElement(By.XPath("//div[contains(@id, 'child')]//div[@class='col-numberbox-button']//button[@aria-label='Increment']"));
            element1.Click();
